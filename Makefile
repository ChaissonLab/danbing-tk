...
TARGETS = aQueryFasta amphQueryFasta vntr2kmers 
...
nuQueryFasta:	nuQueryFasta.o
	$(CXX) $(LDFLAGS) -o nuQueryFasta nuQueryFasta.o
nuQueryFasta.o:	nuQueryFasta.cpp
	$(CXX) $(LDFLAGS) -c nuQueryFasta.cpp -o nuQueryFasta.o

nuQueryFasta_g:		nuQueryFasta_g.o
	$(CXX) -g $(LDFLAGS) -o nuQueryFasta_g nuQueryFasta_g.o
nuQueryFasta_g.o:	nuQueryFasta.cpp
	$(CXX) -g $(LDFLAGS) -c nuQueryFasta.cpp -o nuQueryFasta_g.o
...
amphQueryFasta:	amphQueryFasta.o
	$(CXX) $(LDFLAGS) -o amphQueryFasta amphQueryFasta.o
amphQueryFasta.o:	amphQueryFasta.cpp
	$(CXX) $(LDFLAGS) -c amphQueryFasta.cpp -o amphQueryFasta.o
...
fasta2kmers:	fasta2kmers.o
	$(CXX) -o fasta2kmers fasta2kmers.o
fasta2kmers.o:	Fasta2Kmers.cpp
	$(CXX) -c Fasta2Kmers.cpp -o fasta2kmers.o
